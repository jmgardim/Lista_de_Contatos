...
let cmsTableDemo = {
    'Joaozinho 30' : {
        'phone': '45986537458',
        'address' : 'j30@email.com',   
    },
    'Macgayver ' : {
        'phone': '98998743625',
        'address' : 'mac@email.com',   
    },   
};
...
let refreshDOMTable = () => {
    ...
    for (let i = 0; i< cmsTableKeys.length; i++) {
        ...
        currentEditBtn.innerHTML = '<span class="material-icons">edit</span>';
        currentDeleteBtn.innerHTML = '<span class="material-icons">delete</span>';
    ...
    for(let i = 0; i < deleteBtns.length; i++){
        deleteBtns[i].addEventListener('click', ($event) => {
            ...
            let isSure = window.confirm('Você está prestes a deletar o contato de ' + nameToDelete + '?');
            if(isSure)
